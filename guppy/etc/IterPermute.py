...
def iterpermute(*args):
    ...
    jxs = [0] * la
    seen = dict([(tuple(j % lens[i] for i in ixs), 1) for j in range(n)])
...
def test_iterpermute():
    ...
    assert list(iterpermute(list(range(2)), list(range(2, 3)))) == [
        (0, 2),
        (1, 2),
    ]

    assert list(iterpermute(list(range(2)), list(range(2, 4)))) == [
        (0, 2),
        (1, 3),
        (1, 2),
        (0, 3),
    ...
    print(list(iterpermute(list(range(2)), list(range(3)))))
    print(list(iterpermute(list(range(3)), list(range(2)))))
